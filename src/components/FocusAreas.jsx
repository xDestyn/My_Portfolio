  ...
  const focusAreas = [
    {
      ...
      description:
        'Building self-healing systems and streamlining deployment pipelines with n8n, Kubernetes, and CI/CD automation',
    },
    {
      icon: Cloud,
      title: 'Cloud-Native Systems & Microservices',
      description:
        'Architecting resilient, scalable services with containerization, service mesh, and cloud infrastructure',
    },
    {
      icon: Sparkles,
      title: 'AI-Assisted Tooling & Productivity',
      description:
        'Leveraging intelligent automation to accelerate development workflows and enhance team efficiency',
    },
    {
      icon: BarChart3,
      title: 'Observability, Reliability & Performance',
      description:
        'Implementing comprehensive monitoring, logging, and alerting to ensure system health and rapid issue resolution',
    },
  ]
